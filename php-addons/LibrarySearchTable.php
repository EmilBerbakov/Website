...
<script src='js/hideintro.js'></script>
	<div class="dropdown" onclick='hideintro()'>
		<button class="btn btn-dark dropdown-toggle" type="button" id="toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			...
			<div class="dropdown-menu">
				...
				<button class="dropdown-item" type="button" id="OLID" onclick="SearchOption('OLID')">Openlibrary ID</button>
	...
	<tr id="ISBN13-row">
		...
		<td><input type="text" id="ISBN13-input" maxlength="13" name="ISBN_13"></td>
	</tr>
	<tr id="ISBN10-row">
	...
	<tr id="OLID-row">
		...
		<td><input type="text" id="OLID-input" name="OL_ID"></td>
	</tr>
	<tr id="GRID-row">
	...
	<input type="submit" value="Search" style="display:none" onclick="return searchvalid()" id='searchbutton'>

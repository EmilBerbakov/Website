...
<th><div class='dropdown'>
	<button class='btn btn-dark dropdown-toggle' type='button' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false' id='mainbutton' value='None'> <!--onclick='visibilityswitch()'-->Start your search with one of the following:</button>
